...
export function BBLogo({ className = "w-8 h-8", ...props }) {
  return (
    <svg 
      viewBox="0 0 160 160" 
      className={`${className}`} 
      aria-label="BerlinBase Logo (18-J)"
      {...props}
    >
      {/* Layer 1: Yellow B in Background */}
      <path 
        d="M 82 26 L 132 26 C 146 26 156 34 156 46 C 156 56 149 64 140 68 C 152 72 160 82 160 98 C 160 116 146 128 128 128 L 82 128 Z 
           M 104 44 L 104 60 L 122 60 C 126 60 130 56 130 52 C 130 48 126 44 122 44 Z 
           M 104 82 L 104 110 L 124 110 C 130 110 134 104 134 96 C 134 88 130 82 124 82 Z" 
        fill="#F0D722" 
      />

      {/* Layer 2: White B1 in Foreground */}
      <path 
        d="M 25 20 L 78 20 C 95 20 105 28 105 44 C 105 55 98 64 88 68 C 102 72 112 82 112 104 C 112 124 95 138 75 138 L 25 138 Z 
           M 50 42 L 50 60 L 70 60 C 76 60 80 55 80 51 C 80 46 76 42 70 42 Z 
           M 50 84 L 50 115 L 72 115 C 80 115 84 108 84 100 C 84 92 80 84 72 84 Z" 
        fill="#FFFFFF" 
      />

      {/* Layer 3: Monumental 18-J TV Tower in Left Stem (Top w:3.5, Bot w:13.5, Sphere r:12) */}
      <polygon points="35.75,2 39.25,2 44.25,155 30.75,155" fill="#1E2028" />
      <circle cx="37.5" cy="55" r="12" fill="#1E2028" stroke="#FFFFFF" strokeWidth="3" />
    </svg>
  );
}
